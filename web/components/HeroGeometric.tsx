...
export function HeroGeometric({
    ...
    return (
        <div
            className={cn("relative w-full min-h-screen flex flex-col overflow-x-hidden bg-transparent", className)}
            style={{
                containerType: "size",
                ...props.style
            }}
        ...
        >
            ...
            {(title1 || title2 || description) && (
                <div className="relative z-10 w-full flex flex-col items-center justify-center pt-8 pb-8 md:pt-20 md:pb-20">
