...
import { GeminiHighlightProvider } from './providers\\gemini';
import { FasterWhisperProvider } from './providers\\transcription';

const componentRegistry: Record<string, PreviewComponent> = {
  'web\\App.tsx': toPreviewComponent(App),
  'src\\media\\ffmpeg.ts': toPreviewComponent(MediaError),
  'src\\providers\\gemini.ts': toPreviewComponent(GeminiHighlightProvider),
  'src\\providers\\transcription.ts': toPreviewComponent(FasterWhisperProvider),
};
...
const componentExportsMap: Record<string, string[]> = {
  'web\\App.tsx': ["App"],
  'src\\media\\ffmpeg.ts': ["MediaError"],
  'src\\providers\\gemini.ts': ["GeminiHighlightProvider"],
  'src\\providers\\transcription.ts': ["FasterWhisperProvider"],
};
